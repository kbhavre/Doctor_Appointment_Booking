...
const Appointments = ({ appointments }) => {
  return <table className='w-full text-left tex-sm text-gray-500'>
    <thread className='text-xs text-gray-700 uppercase bg-gray-50'>
      <tr>
        ...
        <tr key={item._id}>
          <th scope='row' className='flex items-center px-6 py-4 text-gray-900 whitespace-nowrap'>
            ...
            <div className='pl-3'>
              ...
              <div className='text-nomal text-gray-500' >{item.user.email}</div>
            </div>
          </th>
