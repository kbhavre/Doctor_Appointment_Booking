  ...
  return (
    <form action="">
      ...
      <div className="mt-[30px]">
        ...
        <textarea className='border border-solid border-[#0066ff34] focus:outline outline-primaryColor w-full px-4 py-3 rounded-md' placeholder='Write your message' onClick={() => setReviewText(e.target.value)} rows='5'></textarea>
      </div>
